...
[ApiController]
public class ProcessDescriptionController : ControllerBase<GetProcessDescriptionsListQuery,
    CreateProcessDescriptionCommand, 
    UpdateProcessDescriptionCommand,
    DeleteProcessDescriptionCommand,
    ProcessDescriptionDto>
{
    public ProcessDescriptionController(IMediator mediator) : base(mediator)
    {
    }
}